...
function Pog({ pog, favorites, handleFavClick }) {
    return (
        <div
            className="bg-gray-200 rounded-lg shadow-md overflow-hidden relative flex flex-col transform transition-transform duration-200 hover:scale-105 will-change-transform"
        >
            {/* Favorite button */}
            <button
                className="absolute top-2 right-2 text-5xl z-10 p-1"
